    ...
    <div className="py-20 sm:py-32 md:py-64 lg:py-80 px-6 sm:px-12 md:px-24 lg:px-32 bg-white">
      <div className="max-w-7xl mx-auto">
        <div className="mb-16 md:mb-40 reveal-up">
          <span className="text-stone-300 font-bold tracking-[0.6em] md:tracking-[0.8em] uppercase text-[8px] md:text-[9px] mb-6 md:mb-8 block">The Journey</span>
          <h2 className="text-4xl sm:text-6xl md:text-8xl font-serif text-stone-900 leading-tight">Simple Arrival</h2>
          ...
          <div className="space-y-8 md:space-y-12 reveal-up">
            <div className="flex justify-between items-start">
              <div className="w-16 h-16 md:w-20 md:h-20 rounded-sm bg-stone-900 text-white flex items-center justify-center shadow-2xl">
                <Ship size={24} md:size={32} strokeWidth={1} />
              </div>
              <div className="text-right">
                <p className="text-[7px] md:text-[8px] uppercase tracking-[0.3em] md:tracking-[0.4em] font-bold text-stone-300 mb-1 md:mb-2">Duration</p>
                <p className="text-xl md:text-2xl font-serif text-stone-900">1h 45m</p>
              </div>
            </div>
            
            <div className="space-y-4 md:space-y-6">
              <h3 className="text-2xl md:text-3xl font-serif text-stone-900">Scheduled Speedboat</h3>
            ...
            <div className="grid grid-cols-2 gap-4 md:gap-8 pt-6 md:pt-8 border-t border-stone-50">
              <div>
                <p className="text-[7px] md:text-[8px] uppercase tracking-[0.3em] md:tracking-[0.4em] font-bold text-stone-300 mb-1 md:mb-2">Departure</p>
              ...
              <div>
                ...
                <p className="text-xs md:text-sm font-bold text-stone-900">$50.00 USD</p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8 md:space-y-12 reveal-up" style={{ transitionDelay: '0.2s' }}>
            <div className="flex justify-between items-start">
              <div className="w-16 h-16 md:w-20 md:h-20 rounded-sm bg-stone-100 text-stone-900 flex items-center justify-center">
                <Plane size={24} md:size={32} strokeWidth={1} />
              </div>
              <div className="text-right">
                <p className="text-[7px] md:text-[8px] uppercase tracking-[0.3em] md:tracking-[0.4em] font-bold text-stone-300 mb-1 md:mb-2">Duration</p>
                <p className="text-xl md:text-2xl font-serif text-stone-900">20m + 30m Boat</p>
              </div>
            </div>
            
            <div className="space-y-4 md:space-y-6">
              <h3 className="text-2xl md:text-3xl font-serif text-stone-900">Domestic Air Transit</h3>
              <p className="text-stone-400 text-xs md:text-base leading-relaxed font-light">
            ...
            <div className="grid grid-cols-2 gap-4 md:gap-8 pt-6 md:pt-8 border-t border-stone-50">
              <div>
                <p className="text-[7px] md:text-[8px] uppercase tracking-[0.3em] md:tracking-[0.4em] font-bold text-stone-300 mb-1 md:mb-2">Frequency</p>
                <p className="text-xs md:text-sm font-bold text-stone-900">6+ Flights Daily</p>
              </div>
              <div>
                <p className="text-[7px] md:text-[8px] uppercase tracking-[0.3em] md:tracking-[0.4em] font-bold text-stone-300 mb-1 md:mb-2">Welcome</p>
                <p className="text-xs md:text-sm font-bold text-stone-900">Dharavandhoo Meet</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-[#141f1f] text-white p-8 md:p-24 rounded-sm flex flex-col lg:flex-row items-center gap-12 md:gap-24 relative overflow-hidden reveal-up">
           <div className="grow space-y-6 md:space-y-8 text-center lg:text-left">
             <span className="text-[8px] md:text-[9px] uppercase tracking-[0.6em] md:tracking-[0.8em] font-bold text-white/20">Digital Arrival</span>
             <h4 className="text-3xl sm:text-4xl md:text-6xl font-serif leading-tight">Mandatory Travel <br/>Declaration</h4>
             ...
             <div className="pt-4 md:pt-6">
               ...
               >
                 Complete IMUGA <div className="w-6 md:w-8 h-[1px] bg-stone-900/20 group-hover:w-10 md:group-hover:w-12 transition-all" />
               </a>
             </div>
           </div>
           ...
           <div className="shrink-0 text-center lg:text-right space-y-4">
             <div className="w-16 h-16 md:w-24 md:h-24 border border-white/5 rounded-full flex items-center justify-center mx-auto lg:ml-auto">
               <Info size={24} md:size={32} strokeWidth={1} className="text-white/20" />
             </div>
             <p className="text-[7px] md:text-[8px] uppercase tracking-[0.3em] md:tracking-[0.4em] font-bold text-white/20">Local Support</p>
             <p className="text-lg md:text-2xl font-serif italic text-white/60">Staff Meet & Greet <br/>Included</p>
           </div>
        </div>
      </div>
    </div>
